Lemma test_incomplete_proof1 : forall (P Q R : Prop), (P -> Q) -> (Q -> R) -> P -> R.
Proof.
...
Fact test_incomplete_proof5 : forall x: bool, x = true \/ x = false. 
Proof. 
    destruct x.
    - admit.
    - now right. 
...
Remark test_incomplete_proof6 : forall x: bool, x = true \/ x = false. 
Proof. 
    destruct x.
    - admit.
    - now right. 
